...
class Users extends Component
{
    ...
    $country,$governorate,$city,$address, $land_line,$phone, $fax, $whatsApp,$shippingAddresses;

    public $upd_name,$upd_email,$upd_user_name,$upd_password,$upd_is_active,$upd_default_language,
    $upd_country,$upd_governorate,$upd_city,$upd_address, $upd_land_line,$upd_phone, $upd_fax, $upd_whatsApp,$user_id,$upd_shippingAddress;
