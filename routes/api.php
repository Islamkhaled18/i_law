...
use App\Http\Controllers\User\Api\ShippingAddressController;
...
Route::get('/countries', [CountyController::class, 'index']);
Route::get('/governorates/{country}', [GovernorateController::class, 'governoratesByCountry']);
Route::get('/cites/{governorate}', [CityController::class, 'citesByGovernorate']);
