        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel1">{{ trans('admin.edit_country') }}</h4>
                ...
                <div class="modal-body">
                    ...
                    <form wire:submit.prevent="updateCountry">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="{{ trans('admin.country_code') }}" wire:model="upd_country_code">
                            <span class="text-danger"> @error('upd_country_code') {{ $message }}@enderror</span>
                        </div>

                        <div class="form-group">
                            <label for="">{{ trans('admin.country_phone_code') }}</label>
                            <input type="text" class="form-control" placeholder="{{ trans('admin.country_phone_code') }}" wire:model="upd_country_phone_code">
                            <span class="text-danger"> @error('upd_country_phone_code') {{ $message }}@enderror</span>
                        </div>
                        <div class="form-group">
                            <label for="">{{ trans('admin.currency') }}</label>
                            <select class="form-control" wire:model="upd_currency">
