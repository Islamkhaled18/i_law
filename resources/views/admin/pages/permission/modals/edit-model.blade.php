...
<div class="basic-modal">
    ...
    <!-- Modal -->
    <div class="modal fade text-start editPermission" wire:ignore.self id="default" tabindex="-1"
        aria-labelledby="myModalLabel1" aria-hidden="true" data-keyboard="false" data-backdrop="static">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel1">Edit Permission</h4>
                ...
                <div class="modal-body">
                    ...
                    <form wire:submit.prevent="updatePermission">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Guard" wire:model="upd_guard">
                            <span class="text-danger"> @error('upd_guard')
                                    {{ $message }}
                                @enderror
                            </span>
                        </div>
