        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel1">Add new City</h4>
                ...
                <div class="modal-body">
                    ...
                    <form wire:submit.prevent="saveCity">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="City code" wire:model="city_code">
                            <span class="text-danger"> @error('city_code') {{ $message }}@enderror</span>
                        </div>    
                        <div class="form-group">
