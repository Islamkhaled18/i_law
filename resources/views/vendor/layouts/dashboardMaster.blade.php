...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('assets/admin/css-rtl/plugins/extensions/ext-component-toastr.css') }}">
    <!-- END: Page CSS-->
...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static   menu-collapsed" data-open="click"
            ...
            <ul class="nav navbar-nav align-items-center ms-auto">
                    ...
                    <ul class="dropdown-menu dropdown-menu-media dropdown-menu-end">
                        ...
                        <li class="scrollable-container media-list"><a class="d-flex" href="#">
                                <div class="list-item d-flex align-items-start">
                                    <div class="me-1">
                                        <div class="avatar"><img
                                                src="{{ asset('assets/admin/images/portrait/small/avatar-s-15.jpg') }}"
                                ...
                                <div class="list-item d-flex align-items-start">
                                    <div class="me-1">
                                        <div class="avatar"><img
                                                src="{{ asset('assets/admin/images/portrait/small/avatar-s-3.jpg') }}"
                                                alt="avatar" width="32" height="32"></div>
                                    </div>
                                    <div class="list-item-body flex-grow-1">
                ...
                <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link"
                        ...
                        @if (auth()->user()->image === null)
                            <img src="{{ asset('assets/admin/images/avatars/2.png') }}" id="blah" height="40"
                                width="40" alt="your image">
                        @else
                            <span class="avatar"><img class="round" <img
                                    src="{{ url('storage/photos/vendors') }}/{{ auth()->user()->image }}"
                    ...
                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user"><a
                            class="dropdown-item" href="{{ route('vendor.profileVendor') }}"><i
                                class="me-50" data-feather="user"></i> {{ trans('admin.profile') }}</a>
    ...
    <ul class="main-search-list-defaultlist d-none">
        ...
        <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between w-100"
                ...
                <div class="d-flex">
                    <div class="me-75"><img src="{{ asset('assets/admin/images/icons/xls.png') }}"
        ...
        <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between w-100"
                href="app-file-manager.html">
                <div class="d-flex">
                    <div class="me-75"><img src="{{ asset('assets/admin/images/icons/jpg.png') }}"
                            alt="png" height="32"></div>
                    <div class="search-data">
        ...
        <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between w-100"
                href="app-file-manager.html">
                <div class="d-flex">
                    <div class="me-75"><img src="{{ asset('assets/admin/images/icons/pdf.png') }}"
                            alt="png" height="32"></div>
                    <div class="search-data">
        ...
        <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between w-100"
                href="app-file-manager.html">
                <div class="d-flex">
                    <div class="me-75"><img src="{{ asset('assets/admin/images/icons/doc.png') }}"
                            alt="png" height="32"></div>
                    <div class="search-data">
        ...
        <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between py-50 w-100"
                ...
                <div class="d-flex align-items-center">
                    <div class="avatar me-75"><img
                            src="{{ asset('assets/admin/images/portrait/small/avatar-s-8.jpg') }}" alt="png"
                            height="32"></div>
                    <div class="search-data">
        ...
        <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between py-50 w-100"
                ...
                <div class="d-flex align-items-center">
                    <div class="avatar me-75"><img
                            src="{{ asset('assets/admin/images/portrait/small/avatar-s-1.jpg') }}" alt="png"
                            height="32"></div>
                    <div class="search-data">
        ...
        <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between py-50 w-100"
                ...
                <div class="d-flex align-items-center">
                    <div class="avatar me-75"><img
                            src="{{ asset('assets/admin/images/portrait/small/avatar-s-14.jpg') }}" alt="png"
                            height="32"></div>
                    <div class="search-data">
        ...
        <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between py-50 w-100"
                ...
                <div class="d-flex align-items-center">
                    <div class="avatar me-75"><img
                            src="{{ asset('assets/admin/images/portrait/small/avatar-s-6.jpg') }}" alt="png"
                            height="32"></div>
                    <div class="search-data">
        ...
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item me-auto"><a class="navbar-brand"
                        href="../../../html/rtl/vertical-collapsed-menu-template/index.html"><span
                            class="brand-logo">
