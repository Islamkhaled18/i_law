...
<head>
    ...
    <title>لوحة تحكم البائعين</title>
...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static   menu-collapsed" data-open="click" data-menu="vertical-menu-modern" data-col="">
        ...
        <div class="navbar-container d-flex content">
            ...
            <ul class="nav navbar-nav align-items-center ms-auto">
                ...
                <li class="nav-item dropdown dropdown-cart me-25"><a class="nav-link" href="#" data-bs-toggle="dropdown"><i class="ficon" data-feather="shopping-cart"></i><span class="badge rounded-pill bg-primary badge-up cart-item-count">6</span></a>
                    <ul class="dropdown-menu dropdown-menu-media dropdown-menu-end">
                        ...
                        <li class="scrollable-container media-list">
                            <div class="list-item align-items-center"><img class="d-block rounded me-1" src="{{asset("assets/admin/images/pages/eCommerce/1.png")}}" alt="donuts" width="62">
                            ...
                            <div class="list-item align-items-center"><img class="d-block rounded me-1" src="{{asset("assets/admin/images/pages/eCommerce/7.png")}}" alt="donuts" width="62">
                                <div class="list-item-body flex-grow-1"><i class="ficon cart-item-remove" data-feather="x"></i>
                                    <div class="media-heading">
                            ...
                            <div class="list-item align-items-center"><img class="d-block rounded me-1" src="{{asset("assets/admin/images/pages/eCommerce/2.png")}}" alt="donuts" width="62">
                                <div class="list-item-body flex-grow-1"><i class="ficon cart-item-remove" data-feather="x"></i>
                                    <div class="media-heading">
                            ...
                            <div class="list-item align-items-center"><img class="d-block rounded me-1" src="{{asset("assets/admin/images/pages/eCommerce/3.png")}}" alt="donuts" width="62">
                                <div class="list-item-body flex-grow-1"><i class="ficon cart-item-remove" data-feather="x"></i>
                                    <div class="media-heading">
                            ...
                            <div class="list-item align-items-center"><img class="d-block rounded me-1" src="{{asset("assets/admin/images/pages/eCommerce/5.png")}}" alt="donuts" width="62">
                                <div class="list-item-body flex-grow-1"><i class="ficon cart-item-remove" data-feather="x"></i>
                                    <div class="media-heading">
                ...
                <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="user-nav d-sm-flex d-none"><span class="user-name fw-bolder">John Doe</span><span class="user-status">Admin</span></div><span class="avatar"><img class="round" src="{{asset("assets/admin/images/portrait/small/avatar-s-11.jpg")}}" alt="avatar" height="40" width="40"><span class="avatar-status-online"></span></span>
                    </a>
                            ...
                            <a class="dropdown-item" href="page-pricing.html">
                                ...
                                Pricing</a><a class="dropdown-item" href="page-faq.html">
                                    <i class="me-50" data-feather="help-circle"></i>
                                     FAQ</a><a class="dropdown-item" href="{{route('admin.logout')}}">
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            @include('vendor.layouts.sidebar-dashboard')
        </div>
    </div>
    <!-- END: Main Menu-->
