            ...
            <div class="card card-browser-states">
                ...
                <div class="card-body">
                    <div class="browser-states">
                        <div class="d-flex">
                            <img src="{{asset("assets/admin/images/icons/google-chrome.png")}}" class="rounded me-1" height="30" alt="Google Chrome" />
                    ...
                    <div class="browser-states">
                        <div class="d-flex">
                            <img src="{{asset("assets/admin/images/icons/mozila-firefox.png")}}" class="rounded me-1" height="30" alt="Mozila Firefox" />
                    ...
                    <div class="browser-states">
                        <div class="d-flex">
                            <img src="{{asset("assets/admin/images/icons/apple-safari.png")}}" class="rounded me-1" height="30" alt="Apple Safari" />
                    ...
                    <div class="browser-states">
                        <div class="d-flex">
                            <img src="{{asset("assets/admin/images/icons/internet-explorer.png")}}" class="rounded me-1" height="30" alt="Internet Explorer" />
                    ...
                    <div class="browser-states">
                        <div class="d-flex">
                            <img src="{{asset("assets/admin/images/icons/opera.png")}}" class="rounded me-1" height="30" alt="Opera Mini" />
