                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <a href="index.html" class="brand-logo">
                                    ...
                                    <h2 class="brand-text text-primary ms-1"> لوحة تحكم البائعين</h2>
                                </a>

                                <h4 class="card-title mb-1">اهلا بك في لوحة تحكم البائعين</h4>
                                <p class="card-text mb-2">من فضلك سجل الدخول بحسابك لبدء المغامرة</p>

                                <form class="auth-login-form mt-2" action="{{route('vendor.post.login')}}" method="post"
                                  novalidate>
                                @csrf
                                ...
                                <div class="mb-1">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <a href="{{route('vendor.forgot.password.form')}}">
