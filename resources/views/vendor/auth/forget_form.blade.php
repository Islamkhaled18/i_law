...
<head>
    ...
    <title>صفحة تذكر كلمة المرور</title>
                    ...
                    <div class="auth-inner my-2">
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                ...
                                <form class="auth-forgot-password-form mt-2" action="{{route('vendor.forgot.password.link')}}" method="POST">
                                    @csrf
                                    <div class="mb-1">
                                        <label for="email" class="form-label">Email</label>
                                        <input type="text" value="{{ old('email') }}"  class="form-control" id="email" name="email" placeholder="البريد الالكتروني" aria-describedby="email" tabindex="1" autofocus />
                                    </div>
                                    <button type="submit" class="btn btn-primary w-100" tabindex="2">Send reset link</button>
                                </form>

                                <p class="text-center mt-2">
                                    <a href="{{route('vendor.login')}}"> <i data-feather="chevron-left"></i> Back to login </a>
                                </p>
                            </div>
                        </div>
                        <!-- /Forgot Password basic -->
